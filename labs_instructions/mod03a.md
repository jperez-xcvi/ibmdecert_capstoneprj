...
Throughout this lab you will be prompted to take screenshots and save them on your own device. These screenshots will be required either to answer graded quiz questions or to upload as part of your submission. You can use various free screengrabbing tools to do this or use your operating system&#39;s shortcut keys to do this (for example Alt+PrintScreen in Windows).
